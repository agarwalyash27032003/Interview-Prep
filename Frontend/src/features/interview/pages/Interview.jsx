                        ...
                        Attempt Mock
                            ...
                            <div className='mock-list'>
                                ...
                                {mockReports?.map((mock, index) => {
                                    ...
                                    const scoreClass =
                                        mock.overallScore >= 80
                                            ? "high"
                                            : mock.overallScore >= 60
                                                ? "medium"
                                                : "low"
                                        ...
                                        >
                                            ...
                                            <div className='mock-card__top'>
                                                ...
                                                <div>
                                                    ...
                                                    <div className='mock-card__badge'>
                                                        Mock #{index + 1}
                                                    </div>
                                                ...
                                                <div
                                                    className={`mock-card__status ${mock.status}`}
                                                >
                                                    {mock.status}
                                                </div>
                                            ...
                                            <div className='mock-card__stats'>
                                                ...
                                                <div className='mock-stat'>
                                                    ...
                                                    <span
                                                        className={`mock-stat__score ${scoreClass}`}
                                                    >
                                                        {
                                                            isCompleted
                                                                ? `${mock.overallScore}%`
                                                ...
                                                <div className='mock-stat'>
                                                    ...
                                                    <span className='mock-stat__value'>
                                                        {
                                                            mock.completedSections?.length || 0
                                                        }
                                                    </span>
